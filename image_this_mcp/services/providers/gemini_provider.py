...
This provider wraps the existing Gemini image generation service,
providing compatibility with the multi-provider architecture.
"""
...
from ...config.settings import GeminiConfig, BaseModelConfig
...
class GeminiProvider(BaseImageProvider):
    ...
    def __init__(
        ...
        Args:
            ...
            config: Gemini configuration (Flash or Pro)
            storage_service: Optional image storage service
        """
        self.client = client
        self.config = config
    ...
    def generate_images(
        ...
        **kwargs
        ...
        Args:
            ...
            **kwargs: Additional parameters (e.g., thinking_level, enable_grounding)
        ...
        with ProgressContext(
            ...
            if input_images:
                ...
                image_parts = self.client.create_image_parts(
            ...
            for i in range(n):
                try:
                    ...
                    response = self.client.generate_content(
                        contents, aspect_ratio=aspect_ratio, **kwargs
                    )
                    images = self.client.extract_images(response)
        ...
        **kwargs
        ...
        with ProgressContext(
            ...
            try:
                ...
                image_parts = self.client.create_image_parts([image_b64], [mime_type])
                ...
                image_bytes_list = self.client.extract_images(response)
    ...
    def validate_config(self) -> bool:
        ...
        try:
            # Lightweight validation: check if we can create a client
            # Actual API call test is optional to avoid unnecessary requests
            return bool(self.client)
        except Exception as e:
            self.logger.error(f"Gemini config validation failed: {e}")
            return False
    ...
    def _get_capabilities(self) -> Dict[str, Any]:
        ...
        capabilities = {
            ...
            "supported_aspect_ratios": ["1:1", "2:3", "3:2", "3:4", "4:3", "16:9", "9:16", "21:9"],
            "supports_editing": True,
            "supports_reference_images": True,
            "max_inline_image_size": self.config.max_inline_image_size,
